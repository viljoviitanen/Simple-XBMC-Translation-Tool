translationtool.py is a simple tool to check if XBMC addon strings.xml files of different
...
see xbmc forum thread at http://forum.xbmc.org/showthread.php?t=118978
